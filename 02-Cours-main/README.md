...
3. [Module 5 : Sécurité et conformité](#module-5-sécurité-et-conformité)
    ...
    9. [Quel service AWS peut être utilisé pour stocker des éléments, tels que des informations d'identification de base de données, de manière sécurisée sans avoir à les coder en dur dans le code source ou un fichier de configuration ?](#quel-service-aws-peut-être-utilisé-pour-stocker-des-éléments-tels-que-des-informations-didentification-de-base-de-données-de-manière-sécurisée-sans-avoir-à-les-coder-en-dur-dans-le-code-source-ou-un-fichier-de-configuration)
